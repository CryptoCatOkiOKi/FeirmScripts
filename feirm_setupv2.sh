...
NAME="feirm"
NAMEALIAS="feirm"
URL="https://github.com/feirm/feirm/releases/download/v2.2.2/feirm-2.2.2-x64_linux.tar.gz"
WALLETDL="feirm-2.2.2-x64_linux.tar.gz"
# WALLETDLFOLDER="feirm-1.3.0"
...
for i in `seq 1 1 $MNCOUNT`; do 
    ...
    if [ -z "$PID" ]; then
        ...
        wget https://bootstraps.feirm.com/feirm-2020-01-23T22:57:32+01:00.zip -O bootstrap.zip
        # rm -R peers.dat 
	    rm -R ./database
	    rm -R ./blocks	
	    rm -R ./sporks
